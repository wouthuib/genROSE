...
class CPlayer: public CCharacter
{
   ...
   //LMA: last shout.
    ...
    bool spam_chat;
    long int next_chat;
    long int next_whisper;
    int nb_chats;
    int nb_whispers;

    //LMA: for union chat spam
    bool spam_chat_union;
    long int next_chat_union;
    int nb_chat_union;

    //LMA: for chat trade
    bool spam_chat_trade;
    long int next_chat_trade;
    int nb_chat_trade;
    ...
    // Time
	long int lastRegenTime;
	long int lastRegenTime_hp;   //LMA: regen for HP
	long int lastRegenTime_mp;   //LMA: regen for MP
	long int lastShowTime;       //LMA HP Jumping
	long int firstlogin;         //LMA for fairy
	long int lastSaveTime;
    long int lastportalchecktime;  //custom events
    long int lastEventTime;        //custom events
    long int RefreshEventTimer;	  //custom events
	long int lastGG;
