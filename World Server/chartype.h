...
struct USEDITEM
{
    long int lastRegTime; // Last Regeneration
...
struct SHOP
{
    ...
    UINT Selling;
    UINT ShopType;
    long int mil_shop_time;   //LMA: Timer for shop time (mileage).
};
...
struct SKILLS
{
	unsigned id;
	unsigned level;
	long int cooldown_skill;   //LMA: cooldown for skills.
	CSkills* thisskill;
};
