...
class CCharServer : public CServerSocket
{
    public:
        ...
        // Extra functions
        CChanels* GetChannelByID( unsigned int id );
        CCharClient* GetClientByUserID( unsigned int userid );
        ...
        bool DiscoAllAvatars(unsigned int userid ); //LMA: Against same account hack.
        ...
        int GetNbUserID( unsigned int userid ); //LMA: Against same account hack.
